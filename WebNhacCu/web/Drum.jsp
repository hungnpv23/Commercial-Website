...
<%-- 
    Document   : Drum
    Created on : Jun 9, 2022, 7:09:32 PM
    Author     : DELL
--%>
...
<html lang="en">
    ...
    <body class="main-layout">
        ...
        <div class="Drum_text">Drum</div>
        <div class="collection_section layout_padding">
            <div class="container">
                <h1 class="new_text"><strong>New Arrivals Drum</strong></h1>
                <p class="consectetur_text"></p>
            </div>
        </div>
        <div class="layout_padding gallery_Drum_section">
            <div class="container">
                <div class="row">
                    <c:forEach var="o" items="${drumlist}">
                        <div class="col-sm-4">

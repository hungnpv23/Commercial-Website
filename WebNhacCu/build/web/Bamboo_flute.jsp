...
<%-- 
    Document   : Bamboo_flute
    Created on : Jun 9, 2022, 7:11:22 PM
    Author     : DELL
--%>
...
<html lang="en">
    ...
    <body class="main-layout">
        ...
        <div class="header_section header_main">
            ...
            <div class="BambooFlute_text">Bamboo flute</div>
            <div class="collection_section layout_padding">
                <div class="container">
                    <h1 class="new_text"><strong>New Arrivals Flute</strong></h1>
                    <p class="consectetur_text"></p>
                </div>
            </div>
            <div class="layout_padding gallery_flute_section">
                <div class="container">
                    <div class="row">
                    <c:forEach var="o" items="${flutelist}">
                        <div class="col-sm-4">
